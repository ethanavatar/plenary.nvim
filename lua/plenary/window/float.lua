...
function win_float.centered_with_top_win(top_text, options)
    ...
    local minor_win_id =
        vim.api.nvim_open_win(minor_bufnr, true, minor_win_opts)
    ...
    local primary_win_id =
        vim.api.nvim_open_win(primary_bufnr, true, primary_win_opts)
    ...
    local primary_border =
        Border:new(primary_bufnr, primary_win_id, primary_win_opts, {})
    local minor_border =
        Border:new(minor_bufnr, minor_win_id, minor_win_opts, {})
...
function win_float.percentage_range_window(
    col_range,
    row_range,
    win_opts,
    border_opts
    ...
    local border =
        Border:new(bufnr, win_id, default_win_opts, border_opts or {})
