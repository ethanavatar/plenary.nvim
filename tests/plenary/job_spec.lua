...
describe('Job', function()
    describe('> cat manually >', function()
        ...
        pending(
            'should split stdin across newlines with no ending newline',
            function()
                local results = {}
                local job = Job:new({
                    -- writer = "hello\nword\nthis is\ntj",
        ...
        pending(
            'should return last line when there is no ending newline',
            function()
                local results = {}
                local job = Job:new({
                    command = 'printf',
    ...
    describe('env', function()
        it(
            'should be possible to set one env variable with an array',
            function()
                local results = {}
                local job = Job:new({
                    command = 'env',
        ...
        it(
            'should be possible to set multiple env variables with an array',
            function()
                local results = {}
                local job = Job:new({
                    command = 'env',
        ...
        it(
            'should be possible to set one env variable with spaces and a map',
            function()
                local results = {}
                local job = Job:new({
                    command = 'env',
        ...
        it(
            'should be possible to set multiple env variables with a map',
            function()
                local results = {}
                local job = Job:new({
                    command = 'env',
        ...
        it(
            'should be possible to set multiple env variables with both, array and map',
            function()
                local results = {}
                local job = Job:new({
                    command = 'env',
    ...
    describe('> simple ls >', function()
        ...
        it('should not timeout when completing fast jobs', function()
            ...
            assert(
                (vim.loop.hrtime() - start) / 1e9 < 1,
                'Should not take one second to complete'
            )
        end)
    ...
    describe('chain', function()
        ...
        it(
            'should only run the next job on success when using and_then_on_success',
            function()
                local results = {}
        ...
        it(
            'should only run the next job on failure when using and_then_on_failure',
            function()
                local results = {}
        ...
        it(
            'should run only on success normal functions when using after_success',
            function()
                local results = {}
                local code = 0
        ...
        it(
            'should run only on failure normal functions when using after_failure',
            function()
                local results = {}
                local code = 0
